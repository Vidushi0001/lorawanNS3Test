...
class ClassAEndDeviceLorawanMac : public EndDeviceLorawanMac
{
  public:
    ...
    void OpenPingSlotWindow();
    void ClosePingSlotWindow();
    void OpenPingSlot();
    void ClosePingSlot();
    void OnPingSlotChannelReq(Ptr<Packet>pingSlotChannelReq);
    ...
    void SetPingSlotFrequency(double frequency);
    double GetPingSlotFrequency() const;
    void SetPingSlotDataRate(uint8_t dataRate);
    uint8_t GetPingSlotDataRate() const;
    ...
    void OnRxClassParamSetupReq(Ptr<RxParamSetupReq> rxParamSetupReq) override;
	 void OnRxClassBParamSetupReq(Ptr<RxParamSetupReq> rxParamSetupReq);
	 
	  void SynchronizeWithBeacon(Time beaconTime);
     void StartBeaconTimer();
     void HandleBeaconTimeout();
     void SchedulePingSlot();
     void StartPingSlots();
     void HandlePingSlot();
  ...
  private:
    ...
    uint8_t m_beaconReserved;
    uint8_t m_beaconDataRate; 
	 EventId m_closeBeaconWindow;
    uint8_t m_receiveWindowDurationInSymbols;
    uint32_t m_beaconGuard;
    uint32_t m_beaconWindow;
    Time m_receiveDelayBeacon;
	uint8_t m_pingSlotWindowDurationInSymbols;
	uint8_t m_beaconWindowDurationInSymbols;
	Time m_beaconInterval;
	Time m_pingSlotDuration;
    uint8_t m_pingSlotDataRate;
    double m_pingSlotFrequency;
    EventId m_closePingSlotWindow;
    uint8_t PingSlotChannelReq;
    EventId m_beaconTimerEvent;
     EventId m_pingSlotTimerEvent;
