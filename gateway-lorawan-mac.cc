...
// void GatewayLorawanMac::Send(Ptr<Packet> packet) {
...
//     bool isBeacon = mHdr.IsBeacon();
//     packet->AddHeader(mHdr);

//     if (isBeacon) {
//         // Set specific data rate and frequency for beacons
//         dataRate = BEACON_DATA_RATE;
//         frequency = BEACON_FREQUENCY;
//         NS_LOG_INFO("Sending beacon packet.");
//     }
...
//     params.nPreamble = isBeacon ? BEACON_PREAMBLE_LENGTH : 8;
...
//     if (isBeacon) {
//         // Add beacon-specific information, such as current time
